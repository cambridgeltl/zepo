...
class MistralModel:
    ...
    def mistral_compare(self, msg):
        ...
        chat_response = MistralModel.call_mistral_chat_completion(
            msg, api_params, api_key=self.api_key
        )
        # print(chat_response)
    ...
    @staticmethod
    def get_mistral_chat_message(
        prompt, aspect, with_input=False, eval_method="pairwise comparison"
    ):
