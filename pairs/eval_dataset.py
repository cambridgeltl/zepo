...
if __name__ == "__main__":
    ...
    for input, output, scores in zip(input_doc, output_doc, scores_doc):
        ...
        spearman_corr, kendall_tau, mae = calculate_correlation(
            np.array(scores)[ranking_indices], list(range(len(scores)))
        )
